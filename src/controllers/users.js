...
const processUserRegistrationForm = async (req, res) => {
    ...
    try {
        // Generar un "salt" y cifrar (hash) la contraseña antes de guardarla
        ...
        // Redirigir a la página de inicio tras un registro exitoso
...
const processLogout = async (req, res) => {
    if (req.session.user) {
        delete req.session.user; // O req.session.destroy();
    }
...
const showDashboard = async (req, res) => {
    ...
    // Fetch the projects this user is volunteering for
    ...
    res.render('dashboard', { 
        ...
        email: user.email,
        role: user.role_name,
        volunteeredProjects // Pass the projects to the view
    });
};
